...
public abstract class Board {
	...
	/**
	 * Accesses the size of the board. Note that this is not the number of cards it contains, which will be smaller near
	 * the end of a winning game.
	...
	/**
	 * Method to be completed by the concrete class that determines if the selected cards form a valid group for removal.
