package edu.kyleknobloch.APCS.CaseStudy.Activity7;
...
public class ElevensBoard {
    ...
    /**
     * Determines if the selected cards form a valid group for removal. In Elevens, the legal groups are (1) a pair of
